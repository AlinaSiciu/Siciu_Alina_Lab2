...
namespace Siciu_Alina_Lab2.Data
{
    public class Siciu_Alina_Lab2Context : DbContext
    {
        ...
        public DbSet<Siciu_Alina_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Siciu_Alina_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Siciu_Alina_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
